  ...
  <div class="section-inner">
    ...
    <div class="two-col" style="margin-bottom:20px;">
      ...
      <div class="panel">
        ...
        <div class="table-scroll"><table class="data-table" id="fx-table">
  ...
  <div class="section-inner">
    ...
    <div class="two-col" style="margin-bottom:20px;">
      ...
      <div class="panel">
        ...
        <div class="table-scroll"><table class="data-table" id="gold-reserves-table"><thead><tr><th>Country</th><th>Tonnes</th></tr></thead><tbody></tbody></table></div>
      </div>
    </div>
  ...
  <div class="section-inner">
    ...
    <div class="two-col" style="margin-bottom:16px;">
      <div class="panel">
        ...
        <div class="table-scroll"><table class="data-table" id="gainers-table"><thead><tr><th>Symbol</th><th>Price</th><th>Chg %</th></tr></thead><tbody></tbody></table></div>
      </div>
      <div class="panel">
        <div class="panel-title">Top Losers</div>
        <div class="table-scroll"><table class="data-table" id="losers-table"><thead><tr><th>Symbol</th><th>Price</th><th>Chg %</th></tr></thead><tbody></tbody></table></div>
      </div>
    </div>
...
SECTIONS.push({
  ...
  <div class="section-inner">
    ...
    <div class="panel">
      ...
      <div class="table-scroll"><table class="data-table" id="crypto-table">
  ...
  <div class="section-inner">
    ...
    <div class="two-col" style="margin-bottom:16px;">
      <div class="panel">
        ...
        <div class="table-scroll"><table class="data-table" id="gdp-table"><thead><tr><th>Country</th><th>GDP</th></tr></thead><tbody></tbody></table></div>
      </div>
      <div class="panel">
        <div class="panel-title">Major Central Bank Rates <span class="badge">Illustrative</span></div>
        <div class="table-scroll"><table class="data-table" id="rates-table"><thead><tr><th>Central Bank</th><th>Rate</th></tr></thead><tbody></tbody></table></div>
      </div>
    </div>
